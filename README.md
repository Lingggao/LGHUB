...
| 😸 欢迎加入 [“Ling 的 Windows Insider 小屋”](https://teams.live.com/l/community/FEADGVjrvbHmT_d2Qw) Microsoft Teams 社区 😽 |
| :----------------------------------------------------------: |
...
[**WIP Canary 27982 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27982                |  2025/11/5  | [aka.ms/wip27982](https://blogs.windows.com/windows-insider/2025/11/04/announcing-windows-11-insider-preview-build-27982-canary-channel) |
|       Dev        | 26220.7051 |   2025/11/1   | [aka.ms/WIPDevBeta_1031](https://blogs.windows.com/windows-insider/2025/10/31/announcing-windows-11-insider-preview-build-26220-7051-dev-beta-channels) |
|         Beta         | 26220.7051 |   2025/11/1   | [aka.ms/WIPDevBeta_1031](https://blogs.windows.com/windows-insider/2025/10/31/announcing-windows-11-insider-preview-build-26220-7051-dev-beta-channels) |
...
| [LG523](#LG523) |     **无法获取 Windows 预览体验计划 11 周年成就徽章**。      | 正在处理 |
| [LG524](#LG524) |  **更新至 26220.7051 版本后无法从 Dev 切换至 Beta 频道**。   | 正在调查 |
...
| [LG528](#LG528) |           **新版开始菜单文件夹中的应用图标消失**。           | 正在调查 |
| [LG529](#LG529) | **每次更新后 “辅助功能”>“视觉效果” 菜单中的选项会自动禁用**。 | 正在调查 |
|       ——        | [**Canary - 用户反馈问题**](#1) ▲ \| ▼ [**Canary - 归档 (已做出更改 0 - 7 天)**](#2) |    ——    |
| [LG386](#LG386) |            已提交的反馈在 “我的反馈” 中随机消失。            | 已修复 ✓ |
| [LG396](#LG396) |      截图工具 “颜色选取器” 功能的顶栏无法完整显示文字。      | 已修复 ✓ |
| [LG512](#LG512) |              “照片” 应用中的编辑功能无法使用。               | 已修复 ✓ |
| [LG513](#LG513) |                    夜间模式无法自动关闭。                    | 已修复 ✓ |
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 27982 更新简报](Canary.md)* |    ——    |
...
日期：2025 年 10 月 14 日  
版本：Canary 27965 - 27975  
**问题**：**夜间模式无法自动关闭**。  
状态：Canary 27982 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
典型反馈：[aka.ms/AAya7tp](https://aka.ms/AAya7tp)

---

*部分未收录反馈详见 [WIP Canary 27982 更新简报](Canary.md)*
