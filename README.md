...
| 😸 欢迎加入 [“Ling 的 Windows Insider 小屋”](https://teams.live.com/l/community/FEAd0AVp_B_pTH5Zh4) Microsoft Teams 社区 😽 |
| :----------------------------------------------------------: |

| 灵糕中心设立 [“Microsoft 网站错误 & 本地化问题”](WebLoc/README.md) 板块 |
| :----------------------------------------------------------: |

上次更新时间：2025 年 7 月 19 日 5:00 (UTC+8)。Star 数量：52 ⭐

收录反馈 430 个，其中正在调查 35 个 (含[搁置](#3) 6 个)、正在处理 6 个、已修复 389 个。

反馈更新记录：**今日更新 LG419 - 429**。- Ling 🫡 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)

[**WIP Canary 27902 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27902                |  2025/7/18  | [aka.ms/wip27902](https://blogs.windows.com/windows-insider/2025/07/17/announcing-windows-11-insider-preview-build-27902-canary-channel) |
|       Dev        | **[新]** 26200.5710 |   2025/7/19   | [aka.ms/wip-dev-7-18-25](https://blogs.windows.com/windows-insider/2025/07/18/announcing-windows-11-insider-preview-build-26200-5710-dev-channel) |
|         Beta         | **[新]** 26120.4741 |   2025/7/19   | [aka.ms/wip-beta-7-18-25](https://blogs.windows.com/windows-insider/2025/07/18/announcing-windows-11-insider-preview-build-26120-4741-beta-channel) |
| Release Preview  | **[新]** 26100.4767 |  2025/7/18  | [blogs.windows.com](https://blogs.windows.com/windows-insider/2025/07/10/releasing-windows-11-build-26100-4762-to-the-release-preview-channel) |
...
| [LG420](#LG420) |   **连接 VPN 时出现 KERNEL_SECURITY_CHECK_FAILURE 绿屏**。   | 正在处理 |
| [LG419](#LG419) |         **电脑开机时发出 Windows Vista 启动声音**。          | 正在处理 |
| [LG416](#LG416) |          “设置”>“系统”>“电源和电池” 菜单可能崩溃。           | 正在处理 |
| [LG421](#LG421) |        **“设置” 菜单等对话框中的撇号变为随机字符**。         | 正在处理 |
...
| [LG422](#LG422) |  **Edge Canary 浏览器 (版本 140.0.3443.0) 频繁随机崩溃**。   | 正在调查 |
| [LG423](#LG423) |  **“设置”>“系统”>“电源和电池” 页面不显示电池电量百分比**。   | 正在调查 |
| [LG424](#LG424) |    **“设置”>“鼠标” 菜单中 “主鼠标按钮” 的选项翻译有误**。    | 正在调查 |
| [LG425](#LG425) |             **Steam 游戏的桌面图标分辨率很低**。             | 正在调查 |
| [LG426](#LG426) |          **印地语和马拉地语拼音键盘无法正常工作**。          | 正在调查 |
| [LG427](#LG427) |        **任务管理器 “性能” 页面中的选项卡无法对齐**。        | 正在调查 |
| [LG428](#LG428) |              **更新系统后应用崩溃、系统迟缓**。              | 正在调查 |
...
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 27902 更新简报](Canary.md)* |    ——    |
...
*部分未收录反馈详见 [WIP Canary 27902 更新简报](Canary.md)*
