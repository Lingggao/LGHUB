...
| 😸 欢迎加入 [“Ling 的 Windows Insider 小屋”](https://teams.live.com/l/community/FEAd0AVp_B_pTH5ZiI) Microsoft Teams 社区 😽 |
| :----------------------------------------------------------: |

| 灵糕中心设立 [“Microsoft 网站错误 & 本地化问题”](WebLoc/README.md) 板块 |
| :----------------------------------------------------------: |

上次更新时间：2025 年 8 月 9 日 22:00 (UTC+8)。Star 数量：52 ⭐

收录反馈 443 个，其中正在调查 30 个 (含[搁置](#3) 4 个)、正在处理 7 个、已修复 406 个。
...
[**WIP Canary 27919 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27919                |  2025/8/9  | [aka.ms/wip27919](https://blogs.windows.com/windows-insider/2025/08/08/announcing-windows-11-insider-preview-build-27919-canary-channel) |
|       Dev        | **[新]** 26200.5742 |   2025/8/9   | [aka.ms/wip-dev-8-8-25](https://blogs.windows.com/windows-insider/2025/08/08/announcing-windows-11-insider-preview-build-26200-5742-dev-channel) |
|         Beta         | **[新]** 26120.5742 |   2025/8/9   | [aka.ms/wip-beta-8-8-25](https://blogs.windows.com/windows-insider/2025/08/08/announcing-windows-11-insider-preview-build-26120-5742-beta-channel) |
...
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 27919 更新简报](Canary.md)* |    ——    |
...
*部分未收录反馈详见 [WIP Canary 27919 更新简报](Canary.md)*
