...
| 😸 欢迎加入 [“Ling 的 Windows Insider 小屋”](https://teams.live.com/l/community/FEADGVjrvbHmT_d2Q0) Microsoft Teams 社区 😽 |
| :----------------------------------------------------------: |
...
上次更新时间：2025 年 11 月 11 日 13:00 (UTC+8)。Star 数量：55 ⭐

收录反馈 530 个，其中正在调查 23 个 (含[搁置](#3) 12 个)、正在处理 4 个、已修复 503 个。
...
[**WIP Canary 28000 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                28000                |  2025/11/8  | [aka.ms/Canary_1107](https://blogs.windows.com/windows-insider/2025/11/07/announcing-windows-11-insider-preview-build-28000-canary-channel) |
|       Dev        | 26220.7070 |   2025/11/8   | [aka.ms/WIPDevBeta_1107](https://blogs.windows.com/windows-insider/2025/11/07/announcing-windows-11-insider-preview-build-26220-7070-dev-beta-channels) |
|         Beta         | 26220.7070 |   2025/11/8   | [aka.ms/WIPDevBeta_1107](https://blogs.windows.com/windows-insider/2025/11/07/announcing-windows-11-insider-preview-build-26220-7070-dev-beta-channels) |
| Release Preview  | 26200.7015 |  2025/10/22  | [blogs.windows.com](https://blogs.windows.com/windows-insider/2025/10/21/releasing-windows-11-builds-26100-7015-and-26200-7015-to-the-release-preview-channel) |
| General Availability |    26200.7019    |  2025/10/29  | [support.microsoft.com](https://support.microsoft.com/en-us/help/5067036) |
...
| [LG525](#LG525) |             WinGetCOM.log 文件占用大量硬盘空间。             | 正在调查 |
| [LG526](#LG526) |           “天气” 应用加载缓慢，经常卡在空白页面。            | 正在调查 |
| [LG527](#LG527) |      CrossDeviceService.exe (跨设备服务) 存在内存泄漏。      | 正在调查 |
|       ——        | [**Canary - 用户反馈问题**](#1) ▲ \| ▼ [**Canary - 归档 (已做出更改 0 - 7 天)**](#2) |    ——    |
| [LG482](#LG482) |                    电脑卡顿现象有所加重。                    | 已修复 ✓ |
| [LG490](#LG490) |       更新 Windows 后，已禁用的网络接口在设置中消失。        | 已修复 ✓ |
| [LG502](#LG502) |   即使已关闭应用，更新记事本时仍会提示 “应用正在使用中”。    | 已修复 ✓ |
| [LG509](#LG509) |             无法在小组件中登录 Microsoft 账户。              | 已修复 ✓ |
| [LG523](#LG523) |       无法获取 Windows 预览体验计划 11 周年成就徽章。        | 已修复 ✓ |
| [LG524](#LG524) |    更新至 26220.7051 版本后无法从 Dev 切换至 Beta 频道。     | 已修复 ✓ |
| [LG528](#LG528) |             新版开始菜单文件夹中的应用图标消失。             | 已修复 ✓ |
| [LG529](#LG529) |  每次更新后 “辅助功能”>“视觉效果” 菜单中的选项会自动禁用。   | 已修复 ✓ |
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 28000 更新简报](Canary.md)* |    ——    |
...
日期：2025 年 9 月 13 日  
版本：Canary 27943 - 27982  
**问题**：**电脑卡顿现象有所加重**。  
状态：Canary 28000 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
...
<SPAN ID = 'LG523'/>编号：LG523  
日期：2025 年 11 月 5 日  
版本：ALL  
**问题**：**无法获取 Windows 预览体验计划 11 周年成就徽章**。  
状态：ALL - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
典型反馈：[aka.ms/AAyj5kz](https://aka.ms/AAyj5kz)

<img src="Images/LG523.png" width = "50%" />

---

<SPAN ID = 'LG524'/>编号：LG524  
日期：2025 年 11 月 5 日  
版本：Dev  
**问题**：**更新至 26220.7051 版本后无法从 Dev 切换至 Beta 频道**。  
状态：Dev - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
Microsoft 官方回复：“‘频道切换窗口出现延迟’ 问题已得到解决，现在所有符合条件的设备均可正常切换频道。如果您正在使用 26220.7051 版本，但 Beta 选项仍为灰色，请重新提交反馈。” *(Ling 译)*  
<img src="Images/M.png" width = "14%" />  
典型反馈：[aka.ms/AAyi6dp](https://aka.ms/AAyi6dp)

<img src="Images/LG524.png" width = "60%" />

---

<SPAN ID = 'LG528'/>编号：LG528  
日期：2025 年 11 月 5 日  
版本：Canary 27975 - 27982  
**问题**：**新版开始菜单文件夹中的应用图标消失**。  
状态：Canary 28000 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
典型反馈：[aka.ms/AAyj5lp](https://aka.ms/AAyj5lp)

---

<SPAN ID = 'LG529'/>编号：LG529  
日期：2025 年 11 月 5 日  
版本：Canary 27975 - 27982  
**问题**：**每次更新后 “辅助功能”>“视觉效果” 菜单中的选项会自动禁用**。  
状态：Canary 28000 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
典型反馈：[aka.ms/AAyi6e4](https://aka.ms/AAyi6e4)

---

*部分未收录反馈详见 [WIP Canary 28000 更新简报](Canary.md)*
