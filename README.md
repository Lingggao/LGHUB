...
上次更新时间：2024 年 11 月 27 日 19:00 (UTC+8)。访问次数：6890+

收录反馈 251 个，其中正在调查 9 个 (含[搁置](#3) 1 个)、正在处理 8 个、已修复 234 个。

反馈更新记录：**今日更新 LG247 - 250**。- Ling 💹 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)
...
| [LG249](#LG249) | **鼠标悬停或右键点击任务栏中的应用时，Explorer.exe 崩溃**。  | 正在处理 |
