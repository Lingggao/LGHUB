...
上次更新时间：2025 年 2 月 1 日 22:00 (UTC+8)。访问次数：7620+

收录反馈 287 个，其中正在调查 19 个 (含[搁置](#3) 1 个)、正在处理 6 个、已修复 262 个。

反馈更新记录：**今日更新 LG284 - 286**。- Ling 😪 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)

[**WIP Canary 27783 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                27783                |  2025/1/30  | [aka.ms/wip27783](https://blogs.windows.com/windows-insider/2025/01/29/announcing-windows-11-insider-preview-build-27783-canary-channel) |
|       Dev        |              **[新]** 26120.3073              |   2025/2/1   | [aka.ms/wip-dev-1-31-25](https://blogs.windows.com/windows-insider/2025/01/31/announcing-windows-11-insider-preview-build-26120-3073-dev-and-beta-channels) |
|         Beta         | **[新]** 26120.3073 |   2025/2/1   | [aka.ms/wip-dev-1-31-25](https://blogs.windows.com/windows-insider/2025/01/31/announcing-windows-11-insider-preview-build-26120-3073-dev-and-beta-channels) |
...
| [LG284](#LG284) |                    **无法重置登录密码**。                    | 正在调查 |
| [LG285](#LG285) |            **表情符号面板显示搜索数据缺失错误**。            | 正在调查 |
...
|       ——        | *部分未收录反馈详见 [WIP Canary 27783 更新简报](Canary.md)*  |    ——    |
