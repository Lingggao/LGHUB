...
上次更新时间：2024 年 12 月 20 日 3:00 (UTC+8)。访问次数：7100+

收录反馈 256 个，其中正在调查 6 个 (含[搁置](#3) 1 个)、正在处理 5 个、已修复 245 个。

反馈更新记录：**今日更新 LG251 - 255**。- Ling 🧁 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)

[**WIP Canary 27764 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                27764                |  2024/12/12  | [aka.ms/wip27764](https://blogs.windows.com/windows-insider/2024/12/11/announcing-windows-11-insider-preview-build-27764-canary-channel) |
|       Dev        |              **[新]** 26120.2705              |   2024/12/19   | [aka.ms/wip-dev-12-18](https://blogs.windows.com/windows-insider/2024/12/18/releasing-real-time-translation-in-live-captions-to-more-copilot-pcs-in-the-dev-channel) |
|         Beta         | 22635.4655 (23H2) |   2024/12/14   | [aka.ms/wip-beta-12-13](https://blogs.windows.com/windows-insider/2024/12/13/announcing-windows-11-insider-preview-build-22635-4655-beta-channel) |
...
| [LG251](#LG251) | **安装第三方应用时提示 “您的组织使用 App Control 阻止了此应用”**。 | 正在处理 |
|       ——        | [**Canary - 公告已知问题**](#0) ▲ \| ▼ [**Canary - 用户反馈问题**](#1) |    ——    |
| [LG225](#LG225) |        文件资源管理器 “...” 二级菜单无法向下方弹出。         | 正在调查 |
| [LG252](#LG252) |            **组策略编辑器和服务管理器 UI 错误**。            | 正在调查 |
| [LG253](#LG253) |              **最小化、最大化、关闭按钮消失**。              | 正在调查 |
| [LG254](#LG254) |      **点击 “开始”>“电源” 按钮时，菜单出现速度变慢**。       | 正在调查 |
| [LG255](#LG255) |       **系统闲置时每间隔 20 - 30 分钟记录一个错误**。        | 正在调查 |
