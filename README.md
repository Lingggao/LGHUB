...
上次更新时间：2025 年 3 月 9 日 3:00 (UTC+8)。访问次数：8160+

收录反馈 309 个，其中正在调查 11 个 (含[搁置](#3) 1 个)、正在处理 4 个、已修复 294 个。
...
[**WIP Canary 27808 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27808                |  2025/3/8  | [aka.ms/wip27808](https://blogs.windows.com/windows-insider/2025/03/07/announcing-windows-11-insider-preview-build-27808-canary-channel) |
|       Dev        | 26120.3360 |   2025/3/1   | [aka.ms/wip-dev-2-28-25](https://blogs.windows.com/windows-insider/2025/02/28/announcing-windows-11-insider-preview-build-26120-3360-dev-and-beta-channels) |
|         Beta         | 26120.3360 |   2025/3/1   | [aka.ms/wip-dev-2-28-25](https://blogs.windows.com/windows-insider/2025/02/28/announcing-windows-11-insider-preview-build-26120-3360-dev-and-beta-channels) |
...
| [LG306](#LG306) |    **[27802+]** 部分应用因 d3d9.dll 崩溃而无法正常运行。     | 正在处理 |
...
| [LG307](#LG307) |   Windows 更新时自动重置蜂窝设置，导致 eSIM 设备丢失网络。   | 正在调查 |
...
|       ——        | *部分未收录反馈详见 [WIP Canary 27808 更新简报](Canary.md)*  |    ——    |
