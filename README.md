...
上次更新时间：2025 年 12 月 19 日 1:00 (UTC+8)。Star 数量：56 ⭐

收录反馈 549 个，其中正在调查 26 个 (含[搁置](#3) 12 个)、正在处理 2 个、已修复 521 个。
...
[**WIP Canary 28020.1362 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                28020.1362                |  2025/12/16  | [aka.ms/WIP-Canary-12-15-25](https://blogs.windows.com/windows-insider/2025/12/15/announcing-windows-11-insider-preview-build-28020-1362-canary-channel) |
...
| General Availability |    26200.7462    |  2025/12/10  | [support.microsoft.com](https://support.microsoft.com/en-us/help/5072033) |
...
| [LG514](#LG514) |               新版开始菜单可能自动滚动至顶部。               | 已修复 ✓ |
| [LG503](#LG503) |         鼠标悬停提示可能挡住应用窗口的 “关闭” 按钮。         | 已修复 ✓ |
| [LG517](#LG517) |            每次重启电脑后任务管理器都会自动启动。            | 已修复 ✓ |
| [LG521](#LG521) |             以安全模式启动 Windows 时电脑绿屏。              | 已修复 ✓ |
| [LG537](#LG537) |             文件资源管理器在深色模式下闪烁白光。             | 已修复 ✓ |
| [LG543](#LG543) |                 开启系统动画后桌面壁纸闪烁。                 | 已修复 ✓ |
| [LG544](#LG544) |                  启动 Outlook 时出现崩溃。                   | 已修复 ✓ |
| [LG546](#LG546) |          在 Microsoft 账户网站中找不到自己的设备。           | 已修复 ✓ |
| [LG548](#LG548) |               每次开机后，系统个性化设置丢失。               | 已修复 ✓ |
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 28020.1362 更新简报](Canary.md)* |    ——    |
...
**问题**：**新版开始菜单可能自动滚动至顶部**。  
状态：Canary 28020.1362 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓
...
版本：Outlook  
**问题**：**启动 Outlook 时出现崩溃**。  
状态：Outlook - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓  
...
*部分未收录反馈详见 [WIP Canary 28020.1362 更新简报](Canary.md)*
