...
上次更新时间：2025 年 1 月 17 日 3:00 (UTC+8)。访问次数：7360+

收录反馈 265 个，其中正在调查 6 个 (含[搁置](#3) 1 个)、正在处理 5 个、已修复 254 个。

反馈更新记录：**今日更新 LG264**。- Ling 😕 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)

[**WIP Canary 27774 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27774                |  2025/1/17  | [aka.ms/wip27774](https://blogs.windows.com/windows-insider/2025/01/16/announcing-windows-11-insider-preview-build-27774-canary-channel) |
...
| General Availability |    **[新]** 26100.2894    |  2025/1/15  | [support.microsoft.com](https://support.microsoft.com/en-us/help/5050009) |
