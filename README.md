...
上次更新时间：2025 年 3 月 2 日 23:00 (UTC+8)。访问次数：8060+

收录反馈 308 个，其中正在调查 14 个 (含[搁置](#3) 1 个)、正在处理 8 个、已修复 286 个。

反馈更新记录：**今日更新 LG306 - 307**。- Ling 🚴 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)
...
| [LG306](#LG306) |     **[置顶]** 部分应用因 d3d9.dll 崩溃而无法正常运行。      | 正在处理 |
