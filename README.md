...
&emsp;&emsp;上次更新时间：2024 年 8 月 23 日 19:00 (UTC+8)。访问次数：5490+

&emsp;&emsp;收录反馈 216 个，其中正在调查 10 个 (含[搁置](#3) 3 个)、正在处理 6 个、已修复 200 个。

&emsp;&emsp;反馈更新记录：**今日更新 LG213 - 215**。- Ling 🍋 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)
...
|         频道         |              最新版本               | 时间 (UTC+8) |                             公告                             |
| :------------------: | :---------------------------------: | :----------: | :----------------------------------------------------------: |
|        Canary        |                27686                |  2024/8/16  | [aka.ms/wip27686](https://aka.ms/wip27686) |
...
|         Beta         | 22635.4076 *(23H2)* |   2024/8/20   | [aka.ms/wip-beta-8-19](https://blogs.windows.com/windows-insider/2024/08/19/announcing-windows-11-insider-preview-build-22635-4076-beta-channel) |
...
| [LG213](#LG213) | **打开 “碎片整理和优化驱动器” 时，显示 “找不到 SXSHARED_UCRT.dll” 错误**。 | 正在处理 |
