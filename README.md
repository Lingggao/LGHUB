...
上次更新时间：2025 年 10 月 26 日 1:00 (UTC+8)。Star 数量：54 ⭐

收录反馈 523 个，其中正在调查 30 个 (含[搁置](#3) 14 个)、正在处理 4 个、已修复 489 个。
...
[**WIP Canary 27975 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27975                |  2025/10/24  | [aka.ms/wip27975](https://blogs.windows.com/windows-insider/2025/10/23/announcing-windows-11-insider-preview-build-27975-canary-channel) |
|       Dev        | **[新]** 26220.6982 |   2025/10/25   | [aka.ms/wip-dev-10-24-25](https://blogs.windows.com/windows-insider/2025/10/24/announcing-windows-11-insider-preview-build-26220-6982-dev-channel) |
|         Beta         | **[新]** 26120.6982 |   2025/10/25   | [aka.ms/wip-beta-10-24-25](https://blogs.windows.com/windows-insider/2025/10/24/announcing-windows-11-insider-preview-build-26120-6982-beta-channel) |
...
| General Availability |    26200.6901    |  2025/10/21  | [support.microsoft.com](https://support.microsoft.com/en-us/help/5070773) |
...
| [LG507](#LG507) |  点击 “设置”>“系统”>“存储” 中的驱动器信息时，设置菜单崩溃。  | 已修复 ✓ |
| [LG472](#LG472) |  “动态锁” 功能频繁激活蓝牙控制器，阻止电脑进入低功耗状态。   | 已修复 ✓ |
| [LG500](#LG500) |                  Xbox 应用中的游戏栏崩溃。                   | 已修复 ✓ |
| [LG501](#LG501) |             无法启动 Xbox Cloud Gaming 云游戏。              | 已修复 ✓ |
| [LG515](#LG515) |     任务管理器中的 “以管理员身份运行” 功能无法正常工作。     | 已修复 ✓ |
| [LG518](#LG518) |              无法通过修改注册表禁用任务管理器。              | 已修复 ✓ |
| [LG522](#LG522) |        文件资源管理器的导航窗格中出现两个 OneDrive。         | 已修复 ✓ |
|       ——        | ***注**：部分未收录的问题详见 [WIP Canary 27975 更新简报](Canary.md)* |    ——    |
...
状态：Canary 27975 - <img src="Images/C_0.png" width = "10%" /> - 已修复 ✓
...
*部分未收录反馈详见 [WIP Canary 27975 更新简报](Canary.md)*
