...
上次更新时间：2025 年 2 月 22 日 5:00 (UTC+8)。访问次数：7830+

收录反馈 301 个，其中正在调查 25 个 (含[搁置](#3) 1 个)、正在处理 9 个、已修复 267 个。

反馈更新记录：**今日更新 LG289 - 300**。- Ling 🤗 [总览图](https://raw.githubusercontent.com/Lingggao/LGHUB/main/Images/Linggao%20Hub.png) | [反馈更新记录](Documents/Update_Feedback.md) | [平台更新记录](Documents/Update_Platform.md)

[**WIP Canary 27788 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                27788                |  2025/2/6  | [aka.ms/wip27788](https://blogs.windows.com/windows-insider/2025/02/05/announcing-windows-11-insider-preview-build-27788-canary-channel) |
|       Dev        | **[新]** 26120.3291 |   2025/2/22   | [aka.ms/wip-dev-2-21-25](https://blogs.windows.com/windows-insider/2025/02/21/announcing-windows-11-insider-preview-build-26120-3291-dev-and-beta-channels) |
|         Beta         | **[新]** 26120.3291 |   2025/2/22   | [aka.ms/wip-dev-2-21-25](https://blogs.windows.com/windows-insider/2025/02/21/announcing-windows-11-insider-preview-build-26120-3291-dev-and-beta-channels) |
| Release Preview  | 26100.3321 |  2025/2/19  | [blogs.windows.com](https://blogs.windows.com/windows-insider/2025/02/18/releasing-windows-11-build-26100-3321-to-the-release-preview-channel) |
...
| [LG290](#LG290) | **更新 Bitdefender 时电脑 PAGE_FAULT_IN_NONPAGED_AREA 绿屏**。 | 正在调查 |
| [LG291](#LG291) |           **Powershell 和 CMD 无法识别 Winget**。            | 正在调查 |
| [LG292](#LG292) |                     **无法加载小组件**。                     | 正在处理 |
| [LG293](#LG293) |   **HTML 在 Windows Spotlight 的图像描述中显示为纯文本**。   | 正在调查 |
| [LG294](#LG294) | **Microsoft 账户登录窗口随机弹出，提示需要连接网络 (0x800704cf)**。 | 正在调查 |
| [LG295](#LG295) |        **运行 Get-BitLockerVolume 命令时显示错误**。         | 正在调查 |
| [LG296](#LG296) |            **Surface 电脑温度过高 / 续航降低**。             | 正在调查 |
| [LG297](#LG297) |             **Conexant - MEDIA 驱动更新失败**。              | 正在调查 |
| [LG298](#LG298) |    **以管理员身份运行应用时，鼠标指针样式自动变回默认**。    | 正在调查 |
| [LG299](#LG299) |                      **音频服务崩溃**。                      | 正在处理 |
| [LG300](#LG300) |                 **MIDI 键盘无法正常使用**。                  | 正在调查 |
