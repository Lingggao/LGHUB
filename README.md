...
[**WIP Canary 27928 更新简报**](Canary.md) | [往期简报](Documents/Canary_Previous)

|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27928                |  2025/8/21  | [aka.ms/wip27928](https://blogs.windows.com/windows-insider/2025/08/20/announcing-windows-11-insider-preview-build-27928-canary-channel) |
|       Dev        | **[新]** 26200.5761 |   2025/8/23   | [aka.ms/wip-dev-8-22-25](https://blogs.windows.com/windows-insider/2025/08/22/announcing-windows-11-insider-preview-build-26200-5761-dev-channel) |
|         Beta         | **[新]** 26120.5761 |   2025/8/23   | [aka.ms/wip-beta-8-22-25](https://blogs.windows.com/windows-insider/2025/08/22/announcing-windows-11-insider-preview-build-26120-5761-beta-channel) |
| Release Preview  | **[新]** 26100.5067 |  2025/8/22  | [blogs.windows.com](https://blogs.windows.com/windows-insider/2025/08/14/releasing-windows-11-build-26100-5061-to-the-release-preview-channel) |
...
| [LG446](#LG446) | **在 “运行” 中启动 CMD 时，出现的是控制台主机而非 Windows 终端**。 | 正在处理 |
| [LG447](#LG447) |            **DWM 崩溃 (黑屏 / 闪烁) 次数增加**。             | 正在处理 |
...
| [LG452](#LG452) |                **Windows 搜索无法正常工作**。                | 正在调查 |
| [LG453](#LG453) | **使用 “将当前用户设置复制到......” 选项时，设置菜单崩溃**。 | 正在处理 |
| [LG454](#LG454) | **使用 ISO 安装 Canary 27924 的过程中，无法使用 “讲述人” 功能**。 | 正在调查 |
| [LG455](#LG455) |               **文件资源管理器窗口随机死锁**。               | 正在调查 |
...
*部分未收录反馈详见 [WIP Canary 27928 更新简报](Canary.md)*
