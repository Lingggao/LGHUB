...
| 编号  |                        问题                         |                   状态                   |
| :---: | :-------------------------------------------------: | :--------------------------------------: |
| LG000 | **无法下载 Build 26016 更新，显示 8024200D 错误**。 | <img src="Images/W.png" width = "50%" /> |
| LG001 |        **无法打开设置菜单 / 设置菜单崩溃**。        | <img src="Images/L.png" width = "50%" /> |
| LG002 |         **部分热门游戏可能无法正常运行**。          | <img src="Images/I.png" width = "60%" /> |
|       |                                                     |                                          |
|       |                                                     |                                          |
|       |                                                     |                                          |
|       |                                                     |                                          |
