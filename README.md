...
上次更新时间：2025 年 1 月 30 日 15:00 (UTC+8)。访问次数：7590+

收录反馈 284 个，其中正在调查 16 个 (含[搁置](#3) 1 个)、正在处理 6 个、已修复 262 个。
...
|         频道         |              最新版本               | 时间 (UTC+8) | 公告 |
| :------------------: | :---------------------------------: | :----------: | :------------------: |
|        Canary        |                **[新]** 27783                |  2025/1/30  | [aka.ms/wip27783](https://blogs.windows.com/windows-insider/2025/01/29/announcing-windows-11-insider-preview-build-27783-canary-channel) |
