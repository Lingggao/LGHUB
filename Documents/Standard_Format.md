...
版本：Canary xxxxx  
**问题**：**xxxxx**  
状态：正在调查 9 / 正在处理 9 / 需要更多详细信息 15 / 所做的更改 10 / (其他)  
...
状态：**◆用户告知◆** → 递交反馈 (日期) → 等待 Microsoft 处理 → 已处理 | 90 天未处理 · 二次递交  
用户：[鸣谢] / 匿名  
传递人：Ling Gao  
图像 (必需)

<img src="https://github.com/Lingggao/LGHUB/blob/main/Images/LING_2.png?raw=true" width = "50%" />
```